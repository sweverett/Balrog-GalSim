...
def main():
    ...
    hdulist = fitsio.FITS(merged_file, columns=flag_cols, mode='rw')
    tdata = hdulist[1].read()
    cols = hdulist[1].get_colnames()
    ...
    if (skipflag & 0b1000000) == False:
        ...
        print('Writing FLAGS_GOLD')
        hdulist[1].insert_column('FLAGS_GOLD', flag_gold)
